...
def init_school(school: School) -> None:
    ...
    # création des cours
    francais = Course(
        "Français", date(2024, 1, 29), date(2024, 2, 16)
    )
    histoire = Course(
        "Histoire", date(2024, 2, 5), date(2024, 2, 16)
    )
    geographie = Course(
        "Géographie", date(2024, 2, 5), date(2024, 2, 16)
    )
    mathematiques = Course(
        "Mathématiques", date(2024, 2, 12), date(2024, 3, 8)
    )
    physique = Course(
        "Physique", date(2024, 2, 19), date(2024, 3, 8)
    )
    chimie = Course(
        "Chimie", date(2024, 2, 26), date(2024, 3, 15)
    )
    anglais = Course(
        "Anglais", date(2024, 2, 12), date(2024, 2, 24)
    )
    sport = Course(
        "Sport", date(2024, 3, 4), date(2024, 3, 15)
    )

    # ajout de ceux-ci à l'école
    for course in [
        francais, histoire, geographie, mathematiques,
...
--------------------------""")
    ...
    # initialisation d'un ensemble de cours, enseignants et élèves
    init_school(school)
